...
from app.domain.schemas.acb import ACBResponse, BossTrace
from app.domain.schemas.estimation import EstimationResult, Phase, TokenUsage
...
def test_acb_returns_structured_response(monkeypatch) -> None:
    ...
    monkeypatch.setattr("app.api.sessions.generate_estimation_acb", fake_generate_acb)
    monkeypatch.setattr("app.api.sessions.extract_project_metadata", fake_extract)
