...
from app.services.compression import apply_compression
from app.services.estimation_service import generate_estimation, generate_estimation_acb
...
def _apply_history_policy(session: Session) -> None:
    if settings.MEMORY_COMPRESSION_ENABLED:
        ...
        apply_compression(
            ...
            compression_model=settings.COMPRESSION_MODEL or settings.PRIMARY_MODEL,
