...
from app.foundation.guardrails.output import enforce_output
...
from app.generation.conversation.transcript import build_acb_turn_context
...
from app.foundation.prompts.loader import render_structured_estimation_prompt
...
def generate_estimation_acb(
    ...
    *,
    ...
    model = request.model or runtime.effective("PRIMARY_MODEL")
    critic_model = runtime.effective("CRITIC_MODEL")
